...
Now extract using the above structure."""
    ...
    def _build_analysis_prompt(
        ...
        prompt += """
            ...
            - If there are files that need to be downloaded and used in the "solution_code", the "solution_code" needs to get the response from the file url and then act on it. Make sure you address in cases of downloaded data files.
            - Make a judgement on what files need to be used. For example, audio and video files might only be of use to you and not in the solution_code's execution.
